  ...
  <div class="success-case-list">
    <div v-if="listMode">
      <el-row>
        ...
        <el-col :span="8">
          <el-button type="primary" icon="el-icon-circle-plus-outline" @click="clickOnAddNew">新增幻灯片资讯</el-button>
        </el-col>
      </el-row>
      <br>
      <el-row>
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="幻灯片资讯图片" width="150px">
    ...
    <div v-if="!listMode">
      <el-row>
        <el-col :span="18">
          <el-form ref="newsForm" :model="formData" :rules="formRule" label-width="220px">
            <el-form-item label="标题:" prop="title">
              <el-input v-model="formData.title" placeHolder="请输入标题"></el-input>
            </el-form-item>
            <el-form-item label="幻灯片资讯图片(尺寸1200 * 500)">
              <el-upload accept=".jpg, .png"
                ...
                <img v-if="newsImg" :src="newsImg" class="avatar" width="600px" height="300px">
